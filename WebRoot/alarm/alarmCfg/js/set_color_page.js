...
function Confirm(){
    ...
    colorLevel[3] = $("#color1").val(); //document.getElementById('level1').value;
    colorLevel[2] = $("#color2").val();//Color.rows(2).cells(1).style.backgroundColor;
    colorLevel[1] = $("#color3").val();
    colorLevel[0] = $("#normal").val();
