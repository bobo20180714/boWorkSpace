...
//            gridhtmlarr.push("                    <div class='l-bar-button l-bar-btnfirst'><span></span></div>");
            ...
            gridhtmlarr.push("                </div>");
            gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            gridhtmlarr.push("                <div class='l-bar-group'><span class='pcontrol'> <input type='text' readonly='readonly' size='4' value='1' style='width:20px' maxlength='3' /></span></div>");
            gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            gridhtmlarr.push("                <div class='l-bar-group'>");
...
//                        g.trigger('loaded', [g]);
        ...
        */
        ...
        _getCellHtml: function (rowdata, column)
        {
            ...
            htmlarr.push('min-height:' + p.rowHeight + 'px;word-wrap:'+p.wordWrap+'; ');
        ...
        _buildPager: function ()
        {
            ...
            if (!p.total)
            {
//                $(".l-bar-btnprev span,.l-bar-btnnext span", g.toolbar)
//                    .addClass("l-disabled");
            }
            if (p.page == 1)
            {
