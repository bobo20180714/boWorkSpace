...
(function ($)
{
    ...
    $.ligerDefaults.Grid = {
        ...
        hideHeadCheckbox: false,                  //头部的复选框是否显示
        ...
        onExportDataList:null,
        isOnlyTurnPage:false   //是否只允许点击上一页或下一页  mengxiangchao add
    };
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            gridhtmlarr.push("                </div>");
            gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            gridhtmlarr.push("                <div class='l-bar-group'><span class='pcontrol'> <input type='text' size='4' value='1' style='width:20px' maxlength='3' />");
            if(!p.isOnlyTurnPage){
                gridhtmlarr.push("                 / <span></span>");
            }
            ...
            if(p.onExportDataList){
            	//导出按钮
            	gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            	gridhtmlarr.push("                <div class='l-bar-group'>");
            	gridhtmlarr.push("                     <div class='l-toolbar-item l-panel-btn l-bar-exportData'><span>导出</span><div class='l-panel-btn-l'></div><div class='l-panel-btn-r'></div></div>");
            	gridhtmlarr.push("                </div>");
            	gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            }
        ...
        */
        ...
        _createHeaderCell: function (column)
        {
            ...
            {
            	if(!p.isSingleCheck && !p.hideHeadCheckbox){
        ...
        _getSrcElementByEvent: function (e)
        {
            ...
            if (r.toolbar)
            {
                ...
                r.exportData = fn("l-bar-exportData");
            }
