...
(function ($)
{
    ...
    var imagePathTemp = "../lib/ligerUI/skins/icons/";
    ...
    $.ligerDefaults.Form.editors.textarea =
    {
        create: function (container, editParm, p)
        {
            ...
            if (editParm.field.readonly) editor.attr("readonly", true);
    ...
    $.ligerui.controls.Form.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _buliderLabelContainer: function (field)
        {
            ...
            var helpTip = field.helpTip;
            if(helpTip){
            	helpTip.img = (helpTip.img == null || helpTip.img == "")?(imagePathTemp+"help.gif"):helpTip.img;
            	helpTip.title = (helpTip.title == null || helpTip.title == "")?"":helpTip.title;
            	out.push('<img style="width:14px;height:14px;"  src="'+helpTip.img+'" title="'+helpTip.title+'">');
            }
