...
function initToolBar(){
	relatedtoolbar = $("#relatedtoolbar").ligerToolBar({
		items:[
		       { text: '添加', id:'addOrelated', click: itemclick,
		    	   icon:'add'
//		    	   img: basePath+'lib/ligerUI/skins/icons/add.gif'
	    	   },
		       { text: '修改', id:'modifyOrelated', click: itemclick,
		    	   icon:'update'
//	    		   img: basePath+'lib/ligerUI/skins/icons/modify.gif'
	    		   },
		       { text: '启用', id:'start', click: itemclick,
    		    	   icon:'start'
//	    			   img: basePath+'lib/ligerUI/skins/icons/up.gif'
	    			   },
		       { text: '删除', id:'deleteOrelated', click: itemclick,
	    		    	   icon:'delete'
//	    				   img: basePath+'lib/ligerUI/skins/icons/delete.gif' 
	...
	fieldtoolbar = $("#fieldtoolbar").ligerToolBar({
		items:[
		       { text: '添加', id:'addField', click: itemclick,
		    	   icon:'add'
//		    	   img: basePath+'lib/ligerUI/skins/icons/add.gif'
		    	   },
		       { text: '修改', id:'modifyField', click: itemclick,
			    	   icon:'update'
//		    		   img: basePath+'lib/ligerUI/skins/icons/modify.gif'
		    		   },
		       { text: '删除', id:'deleteField', click: itemclick,
				    	   icon:'delete'
//		    			   img: basePath+'lib/ligerUI/skins/icons/delete.gif' 
		    			   }
		       ]});
...
function initRelatedGrid(){
	relatedGrid = $("#relatedGrid").ligerGrid({
		columns: [ 
	          ...
	          {display: '信息名称', name: 'jsjg_name',align: 'center',width:200,
	          ...
	          {display: '信息编号', name: 'jsjg_code',align: 'center',width:200},
	          ...
	          {display: '备注', name: 'jsjg_desc',align: 'left',width:350}
	          /*,
	          ...
	          {display: '创建时间', name: 'create_time',align: 'center',width:170}*/
	    ],
	    width: '99.8%', 
	    pageSize: 20,
	    rownumbers:false,
...
//	    delayLoad:true,
	    ...
	    url:basePath+'rest/orbitrelated/queryOrbitRelatedByPage'
	});
	fieldGrid = $("#fieldGrid").ligerGrid({
		columns: [ 
	          { id: 'field_id',name:'field_id',hide:true,width:0.1},
	          {display: '字段英文编号', name: 'field_code',align: 'center',width:120,
	        	  render:function(item){
	        		  if(item.field_code != null){
	        			  return '<div title="'+item.field_code+'">'+item.field_code+'</div>';
	        		  }
	        	  }
	          },
	          {display: '字段中文名称', name: 'field_name',align: 'center',width:120,
	        	  render:function(item){
	          ...
	          {display: '字段精度', name: 'fiel_dscale',align: 'center',width:100},
	         /* {display: '是否为摘要信息', name: 'is_display_flag',align: 'center',width:150,
	          ...
	          {display: "排序序号", name: "field_order",align: 'center',width:80}
	          ],
          dataAction:'server',
          width: '99.8%', 
          pageSize: 20,
	 ...
	 if(item.id){
		 ...
		 case "addOrelated":
	            ...
	            { 
					 ...
					 height:250, 
	                title:"新增卫星相关信息",
					url: basePath+"noParamData/orbitRelated/orbitRelated_add.jsp",
					buttons :[
			            { text: '保存',type:'save', width: 80, onclick:function(item, dialog){
			            	...
			            	if(rsObj.success){
			        			...
			        			$.ligerDialog.warn(rsObj.message);
			            	}
			            }},
