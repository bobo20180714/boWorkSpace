(function($){
	var bigColorPicker = new function(){
		...
		this.setCurrentPicker = function(obj){
			currentPicker = obj;
		};
		...
		this.pickerShow = function(top,left){
			$("#bigpicker").css({"top":top+'px',"left":left+'px'});
			$("#bigpicker").show();
		};
	...
	$.fn.setCurrentPicker = bigColorPicker.setCurrentPicker;
	$.fn.bigColorpicker = bigColorPicker.showPicker;//初始化
	$.fn.pickerShow = bigColorPicker.pickerShow;//显示
