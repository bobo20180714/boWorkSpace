...
<head>
	...
	<script src="<%=basePath %>relateQuery/jquery-form/form-init.js" type="text/javascript"></script>
	<script src="<%=basePath %>relateQuery/selectCondition/js/GraphicalIn.js" type="text/javascript"></script>
...
<body>
	<div id="frameTab">
        <div tabid="imgInput" title="图形化输入" style="height:100%;" >
			...
			<!-- <div class="l-dialog-buttons" style="margin-top: 15px;padding-top: 7px;">
				<div id="confirmbtn"
					...
					class="l-dialog-save-btn" onclick="conditionQuery()" align="center">
				</div>
        ...
        <div tabid="scriptInput" title="脚本输入" style="height:100%;" >
            ...
            <div>
            	<form id="sqlFormSI2"></form>
            </div>
            <!-- <div class="l-dialog-buttons" style="margin-top: 20px;padding-top: 7px;" >
				<div id="confirmbtn"
